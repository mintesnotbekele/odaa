import Data from "@data/sections/honors.json";
                ...
                <div className="container mil-p-120-0">
                    ...
                    <div className="mil-mb-120">
                        ...
                        <div className="mil-complex-text justify-content-center mil-up">
                            <h2 className="mil-h2 mil-muted mil-center" >Honors and Mentions</h2>
...
export default HonorsAndMentions;